        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target=".bd-example-modal-lg">
                    <i class="nav-icon fas fa-plus-square"></i> &nbsp; Tambah Data Guru
                </button>
            </h3>
        </div>
        <!-- /.card-header -->
            ...
            <tbody>
                @foreach ($mapel as $data)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('guru.mapel', $data->id) }}" class="btn btn-info btn-sm"><i class="nav-icon fas fa-list"></i> &nbsp; Detail</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
