          ...
          <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_karyawan" name="nama_karyawan" value="{{ $karyawan->nama_karyawan }}" class="form-control @error('nama_karyawan') is-invalid @enderror">
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="id_card">Nomor ID Card <span class="text-danger">*</span></label>
                    <input type="text" id="id_card" name="id_card" class="form-control" value="{{ $karyawan->id_card }}" readonly>
                </div>
                <div class="form-group">
                    <label for="no_hp">Nomor Telpon/HP <span class="text-danger">*</span></label>
